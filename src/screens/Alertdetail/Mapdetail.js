...
function Mapdetail({route, navigation}) {
  ...
  const [latitudee, setLatitudee] = useState(route.params.userLatitude);
  const [longitudee, setLongitudee] = useState(route.params.userLongitude);
    ...
    <>
      ...
      <View style={styles.container}>
        <MapView
          ...
          />
          {console.log('sd', markerLat + ' ' + markerLong)}
