...
import { GradientHelper2 } from "./gradienthelper2";


const AnimatedGradientHelper = Animated.createAnimatedComponent(GradientHelper2);

export default class Animations2 extends Component {
  state = {
