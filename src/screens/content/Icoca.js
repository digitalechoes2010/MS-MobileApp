    ...
    return(
       ...
       <ScrollView>
           <View style={styles.messageceocontainer}>
               <Text style={{fontSize:normalize(12),color:"black"}}>ISO & ICoCA Affiliate</Text>
...
<View  style={{
      ...
      />
 <Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoca0.jpeg')} />

 <Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain",marginTop:'1%'}}
 
    source={require('../../assets/icoca00.jpeg')} />
     <Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoco1.jpg')} />

<Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoca2.jpg')} />
 <Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoca3.jpg')} />

<Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoca4.jpg')} />
 <Image  style={{alignSelf:"center",width:'100%',resizeMode:"contain"}}
    source={require('../../assets/icoca5.jpg')} />
